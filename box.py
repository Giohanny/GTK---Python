...
class ListBoxWindow(Gtk.Window):
	...
	####
        ...
        link1 = Gtk.LinkButton("https://developer.gnome.org/gnome-devel-demos/stable/c.html.en", "Go tutorial")
        ...
        link2 = Gtk.LinkButton("https://developer.gnome.org/gnome-devel-demos/stable/tutorial.py.html.en","Go tutorial")
        hbox.pack_start(label2, True, True, 0)
        hbox.pack_start(link2, False, True, 0)
